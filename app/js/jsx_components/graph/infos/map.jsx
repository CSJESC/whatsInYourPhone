...
var WorldMap = React.createClass({
  ...
  drawMap: function() {
    ...
    this.canvas.fillStyle = "#ED1C24", this.canvas.beginPath(), this.path(this.countries[this.state.country]), this.canvas.fill();
  ...
  rotate: function() {
    d3.transition()
      ...
      .tween("rotate", function() {
        var p = d3.geo.centroid(this.countries[this.state.country]),
